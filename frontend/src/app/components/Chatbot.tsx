...
import { Button, Textarea, Switch, ScrollShadow } from "@nextui-org/react";
...
export default function Chatbot() {
    ...
    return (
        <div className="fixed bottom-10 right-10 flex flex-col z-10">
            {isOpen ? (
                <div className="bg-background shadow-md w-[500px] rounded-2xl drop-shadow-xl flex flex-col">
                    <div className="flex w-full bg-primary justify-between p-2 rounded-t-2xl items-center">
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <Switch checked={mode === Role.DOCTOR} onChange={handleModeChange} />
                            <div>Doctor Mode</div>
                        </div>
                        <Button isIconOnly className="rounded-full" size="sm" onClick={() => setIsOpen(false)}>
