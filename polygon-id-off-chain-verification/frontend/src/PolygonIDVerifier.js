...
function PolygonIDVerifier({ credentialType, issuerOrHowToLink, onVerificationResult, publicServerURL, localServerURL, }) {
  ...
  return (
    <div>
      <Box p={4} _hover={{ backgroundColor: "gray.50" }} cursor="pointer" onClick={onOpen}>
        <Text fontSize="lg" fontWeight="bold" bgColor="gray.200" mb={2}>
          Pharmacy A Drug Store.
        </Text>
        <Text fontSize="sm" fontWeight={"bold"} mb={1}>
          Metformin Hydrochloride (Glyformet) 500mg Film-Coated...
        </Text>
